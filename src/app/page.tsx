...
function Scene1_CampaignROI() {
  return (
    <div className="space-y-5 fade-in">
      {/* AI insight banner */}
      <IntuitAssistCard
        title="Intuit Assist · Campaign Analyst"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Revenue per $1 Spent by Channel</h3>
          <BarChart
            data={[
              { label: "Meta Ads", value: 4.8, color: "#1877F2" },
              { label: "Google", value: 3.2, color: "#EA4335" },
              { label: "Email", value: 2.1, color: "#2CA01C" },
        ...
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Response Time vs Conversion</h3>
          <BarChart
            data={[
              { label: "< 2h", value: 34, color: "#2CA01C" },
              { label: "2–6h", value: 22, color: "#0077C5" },
              { label: "6–24h", value: 11, color: "#E87040" },
              { label: "> 24h", value: 5, color: "#D13B3B" },
            ]}
            height={180}
          />
          <p className="text-[10px] text-[#9CA3AF] mt-2 text-center">Conversion rate %</p>
        </div>
      </div>

      <div className="qbo-card p-5">
        <h3 className="text-[13px] font-semibold text-[#212B36] mb-3">Campaign Performance — All Channels</h3>
        <DataTable
      ...
      <IntuitAssistCard
        title="Intuit Assist · Speed Coach"
...
function Scene2_Attribution() {
  return (
    <div className="space-y-5 fade-in">
      ...
      <div className="qbo-card p-5">
        <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Ad-to-Cash Attribution — Ledger Verified</h3>
        <div className="flex items-center justify-between gap-1 overflow-x-auto pb-2">
          {[
            { label: "Ad Impression", value: "2,840", color: "#93C5FD" },
            { label: "Ad Click", value: "312", color: "#0077C5" },
            { label: "Lead", value: "84", color: "#4A90D9" },
            { label: "Proposal", value: "22", color: "#2CA01C" },
            { label: "Signed", value: "14", color: "#0D6B3F" },
            { label: "Invoiced", value: "12", color: "#E87040" },
            ...
            <div key={i} className="flex items-center gap-1 shrink-0">
              <div className="text-center">
                ...
                <p className="text-[9px] text-[#9CA3AF] mt-1 leading-tight">{s.label}</p>
              </div>
        ...
        <div className="mt-3 p-2.5 bg-[#F0FAF0] rounded-lg flex items-center gap-2">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="#2CA01C"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" /></svg>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Revenue per $1 Ad Spend</h3>
          <BarChart
            data={[
        ...
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Avg Deal Size by Channel</h3>
          <BarChart
            data={[
              { label: "Google", value: 31000, color: "#EA4335" },
              { label: "Referral", value: 24000, color: "#6C5CE7" },
              { label: "Meta", value: 18000, color: "#1877F2" },
              { label: "Email", value: 12000, color: "#2CA01C" },
            ]}
            height={160}
          />
        </div>
      ...
      <IntuitAssistCard
        title="Intuit Assist · Prospecting Analyst"
...
function Scene3_LeadFunnel() {
  return (
    <div className="space-y-5 fade-in">
      <IntuitAssistCard
        title="Intuit Assist · Leak Doctor"
      ...
      <div className="qbo-card p-5">
        <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">Lead Funnel — Stage Breakdown</h3>
        <FunnelChart
          stages={[
            { label: "New Leads", value: 34, color: "#0077C5", conversion: "100%" },
            { label: "Contacted", value: 28, color: "#4A90D9", conversion: "82%" },
            { label: "Qualified", value: 19, color: "#2CA01C", conversion: "56%" },
            { label: "Proposal", value: 8, color: "#E87040", conversion: "24%" },
      ...
      <div className="qbo-card p-5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-[13px] font-semibold text-[#212B36]">Stale High-Score Leads</h3>
          <StatusBadge status="7 leads · $41K at risk" variant="danger" />
        </div>
        <DataTable
          headers={["Lead", "Source", "Score", "Days Stale", "Est. Value"]}
          rows={[
            ["Jennifer Thompson", "Web Form", <ProgressBar key="p1" value={92} color="#2CA01C" />, <StatusBadge key="s1" status="18 days" variant="danger" />, "$8,200"],
            ["Robert Kim", "Web Form", <ProgressBar key="p2" value={88} color="#2CA01C" />, <StatusBadge key="s2" status="16 days" variant="danger" />, "$6,800"],
            ["Amanda Chen", "Meta Ad", <ProgressBar key="p3" value={82} color="#2CA01C" />, <StatusBadge key="s3" status="15 days" variant="warning" />, "$7,500"],
          ]}
        />
      </div>
    </div>
...
function Scene9_L2CFunnel() {
  return (
    <div className="space-y-5 fade-in">
      ...
      <div className="qbo-card p-5">
        <h3 className="text-[13px] font-semibold text-[#212B36] mb-4">L2C Funnel — Campaign to Cash Collected</h3>
        <FunnelChart
          stages={[
            { label: "Impressions", value: 280, color: "#93C5FD", conversion: "—" },
            { label: "Leads", value: 84, color: "#0077C5", conversion: "30%" },
            { label: "Opportunities", value: 41, color: "#4A90D9", conversion: "49%" },
            { label: "Proposals", value: 22, color: "#2CA01C", conversion: "54%" },
            { label: "Signed", value: 14, color: "#0D6B3F", conversion: "64%" },
            { label: "Invoiced", value: 12, color: "#E87040", conversion: "86%" },
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-3">Customer Profile — The Andersons</h3>
          <div className="grid grid-cols-3 gap-3 mb-3">
            <div><p className="text-[10px] text-[#9CA3AF] uppercase">Revenue</p><p className="text-lg font-bold text-[#212B36]">$67K</p></div>
            <div><p className="text-[10px] text-[#9CA3AF] uppercase">Predicted LTV</p><p className="text-lg font-bold intuit-assist-text">$112K</p></div>
            <div><p className="text-[10px] text-[#9CA3AF] uppercase">Engagement</p><p className="text-lg font-bold text-[#E87040]">Declining</p></div>
          </div>
          <LineChart data={[{ label: "Aug", value: 12 }, { label: "Sep", value: 10 }, { label: "Oct", value: 8 }, { label: "Nov", value: 5 }, { label: "Dec", value: 3 }, { label: "Jan", value: 1 }]} color="#E87040" height={100} />
          <ProgressBar value={65} color="#E87040" label="Churn Risk" />
        </div>
        <div className="qbo-card p-5">
          <h3 className="text-[13px] font-semibold text-[#212B36] mb-3">Weekly Report Builder</h3>
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <div key={m.label} className="p-2.5 bg-[#F4F5F8] rounded-lg">
                <p className="text-sm font-bold text-[#212B36]">{m.value}</p>
          ...
          <div className="flex gap-2 mt-3">
            ...
            <button className="text-[12px] px-3 py-1.5 border border-[#E5E7EB] rounded-md font-medium text-[#212B36]">Export PDF</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <IntuitAssistCard
          title="Intuit Assist · Pathfinder"
        ...
        />
        <IntuitAssistCard
          title="Intuit Assist · Customer Intelligence"
