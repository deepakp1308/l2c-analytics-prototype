    ...
    <div className="qbo-card px-4 py-3 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="text-[13px] border border-[#D1D5DB] rounded-md px-3 py-1.5 bg-white text-[#22262A] font-medium"
        >
      ...
      <div className="flex items-center gap-2.5">
        <span className="text-[12px] text-[#6B7280] font-medium">Exclude Bot Traffic</span>
        <button
          onClick={() => onBotFilterToggle(!botFilterEnabled)}
          className="relative w-[36px] h-[20px] rounded-full transition-colors"
          style={{ backgroundColor: botFilterEnabled ? "#0B7F5C" : "#E5E7EB" }}
        >
          <div
